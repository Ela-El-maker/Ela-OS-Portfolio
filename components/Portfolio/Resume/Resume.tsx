      ...
      <Styled.ResumeWrapper>
        <Styled.LeftColumn>
          <Styled.ContactInfo>
            ...
            <Styled.ContactLink href="mailto: hello@feloela.com">
              <FiMail />
              hello@feloela.com
            </Styled.ContactLink>
        ...
        <Styled.RightColumn>
          ...
          <Styled.SummaryHeader>
            ...
            <Styled.SocialLinksWrapper>
              ...
              <Styled.SocialMediaLink href="mailto: hello@feloela.com">
              ...
              <Styled.SocialMediaLink
                href={'/assets/felo-ela-cv.pdf'}
                download="felo-ela-cv.pdf"
              >
          ...
          <Styled.Projects>
            <p>
              ...
              <Link href={'/portfolio/projects'}>
                feloela.com/portfolio/projects
              </Link>{' '}
